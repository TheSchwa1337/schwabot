...
class ConfigManager:
        ...
        try:
            ...
            validation = ConfigValidation(
                ...
                metadata={
                    ...
                    "valid_parameters": sum(1 for p in self.parameters.values() if self._validate_parameter_value(p.parameter_id, p.value)["valid"])
                }
            )
    ...
    def get_manager_statistics(self) -> Dict[str, Any]:
        ...
        if total_validations > 0:
            successful_validations = sum(1 for v in self.validations.values() if v.validation_score > 0.8)

...
def get_event_history(
    ...
    if event_type:
    events = [e for e in (events for events in ((events for (events in (((events for ((events in ((((events for (((events in (((((events for ((((events in ((((((events for (((((events in ((((((events if e.event_type == event_type)
